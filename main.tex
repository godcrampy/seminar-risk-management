...
\nomenclature[I]{\(OHLC\)}{Open-High-Low-Close Chart}
...
\captionof{figure}{Logistic function curve \cite{jupudi:2018}}
\label{fig:lr}
\end{center}
...
\captionof{figure}{Hyperplane construction in SVM \cite{ruiz:2014}}
\label{fig:svm-1}
\end{center}
...
\captionof{figure}{Kernel mapping to linear boundaries (a) Input Image (b) Feature Space \cite{ruiz:2014}}
\label{fig:svm-2}
\end{center}
\noindent 
...
\captionof{figure}{Example of KNN \cite{alaliyat:2021}}
\label{fig:knn}
\end{center}
...
\captionof{figure}{Fisher's LDA Visualization \cite{cheng:2014}}
\label{fig:lda}
\end{center}
...
\captionof{figure}{Single neuron in an ANN \cite{yigit:2013}}
\label{fig:ann}
\end{center}
...
\captionof{figure}{Distribution of credit based on house type}
\label{fig:dist3}
\end{center}
